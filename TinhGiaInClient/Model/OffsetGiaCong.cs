...
namespace TinhGiaInClient.Model
{
    public class OffsetGiaCong
    {
        ...
        public static List<OffsetGiaCong> DocTatCa()
        {
            ...
            var nguon = offsetGiaCongLogic.DocTatCa().Select(x => new OffsetGiaCong
            {
                ID = x.ID,
                Ten = x.Ten,
        ...
        public static List<OffsetGiaCong> DocTheoNhaCungCap(string tenNCC)
        {
            var offsetGiaCongLogic = new OffsetGiaCongLogic();
            var nguon = offsetGiaCongLogic.DocTheoNhaCungCap(tenNCC).Select(x => new OffsetGiaCong
            {
                ID = x.ID,
                Ten = x.Ten,
                TenNhaCungCap = x.TenNhaCungCap,
        ...
        public static List<string>NhaCungCapS()
        {
            var offsetGiaCongLogic = new OffsetGiaCongLogic();           
            return offsetGiaCongLogic.NhaCungCapS();
        }
